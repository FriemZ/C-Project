...
void updateScore(){
	gotoxy(WIN_WIDTH + 7, 5);cout<<"Poin skor: "<<score<<endl;
}
...
void instructions(){
	...
	cout<<"Instructions";
	cout<<"\n----------------";
	cout<<"\n Tekan spasi untuk loncat";
	cout<<"\n\nTekan dimana saja untuk kembali ke menu";
	getch();
}
...
void play(){
	...
	gotoxy(WIN_WIDTH + 5, 2);cout<<"Mano' Loncat'";
	gotoxy(WIN_WIDTH + 6, 4);cout<<"----------";
	gotoxy(WIN_WIDTH + 6, 6);cout<<"----------";
	gotoxy(WIN_WIDTH + 7, 12);cout<<"Kontrol";
	gotoxy(WIN_WIDTH + 7, 13);cout<<"-------- ";
	gotoxy(WIN_WIDTH + 2, 14);cout<<" Spasi = Loncat";
